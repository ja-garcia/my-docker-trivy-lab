...
RUN apt-get update && apt-get install -y --no-install-recommends openssl && apt-get purge -y --allow-remove-essential perl-base && apt-get autoremove -y && rm -rf /var/lib/apt/lists/*
